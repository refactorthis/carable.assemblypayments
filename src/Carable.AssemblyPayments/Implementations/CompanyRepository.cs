...
{
    internal class CompanyRepository : AbstractRepository, ICompanyRepository
    {
        public CompanyRepository(IRestClient client, ILoggerFactory loggerFactory, IOptions<Settings.AssemblyPaymentsSettings> options)
